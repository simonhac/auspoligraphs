// Swing / demographic scenario engine. Ported verbatim from the
// open-tally-room engine (`@tally` scenario.ts): the auto/manual swing
// redistribution model, the ON-by-demographic resolver, and the reducer
// that drives the SwingPanel / DemographicSkewPanel / FlowMatrixEditor.
